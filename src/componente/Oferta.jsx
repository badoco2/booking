            ...
            <h5 className="padding-top  padding-botom legenda">Home / Ofertas / Grand Hilton Hotel</h5>
                ...
                <div className="w3-row w3-content w3-margin-top">
                    ...
                    <div className="w3-row w3-margin-top">
                        <div className="w3-row w3-rest padding-top padding-botom">
                            <h3>RESUMO</h3>
                        </div>
                        <div className="w3-row w3-half  padding-botom padding-right w3-whites">
                        ...
                        <div className="w3-row w3-half  padding-botom  ">
                         <div className="w3-row w3-rest darkblue">
                                <h4>Detalhes</h4>
                            </div>
                            <div className="w3-row w3-half  w3-padding">
                        ...
                        <div className="w3-row completa w3-white ">
